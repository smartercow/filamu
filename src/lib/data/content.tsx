import { Genre, Genres, Trend, Trends } from "./genres";
...
export type Content = {
  ...
  genres: Genre[];
  trends: Trend[];
  highlight: "home" | "home-slider" | "recommended" | "latest";
  poster: string;
  splash: string;
  video_id: string;
  episodes?: string;
...
export const contentData: Content[] = [
  {
    ...
    type: "movie",
    genres: [Genres[1], Genres[20]],
    trends: [Trends[0], Trends[4]],
    highlight: "home-slider",
    poster: "/assets/content/posters/1-da-5-bloods.png",
    splash: "/assets/content/splash-images/1-da-5-bloods.jpg",
    video_id: "23647897",
    trailer: "D5RDTPfsLAI",
    teaser: "/assets/content/teasers/1-da-5-bloods.mp4",
  ...
  },
  {
    ...
    type: "tv-serie",
    genres: [Genres[4]],
    trends: [Trends[3], Trends[1], Trends[2]],
    highlight: "recommended",
