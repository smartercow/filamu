...
export const Celebrities: Celeb[] = [
  {
    ...
    video: "aFaZ-GvJuVI",
    photos: [
      "/assets/celebrities/photos/1x1-lupita-nyongo.jpg",
      "/assets/celebrities/photos/1x2-lupita-nyongo.jpg",
      "/assets/celebrities/photos/1x3-lupita-nyongo.webp",
    ],
    country: "Kenya",
    celebId: 10020,
    category: "actress",
    ...
    video_thumbnail: "/assets/celebrities/videos/1-lupita-nyongo.png",
  },
  {
    id: 2,
    sex: "male",
    ...
    video: "QdOMyoOu020",
    photos: [
      "/assets/celebrities/photos/2x1-daniel-kaluuya.webp",
      "/assets/celebrities/photos/2x2-daniel-kaluuya.jpg",
      "/assets/celebrities/photos/2x3-daniel-kaluuya.webp",
    ],
    ...
    video_thumbnail: "/assets/celebrities/videos/2-daniel-kaluuya.jpg",
  },
  {
    id: 3,
    sex: "male",
    ...
    video: "HUMgPdyQews",
    photos: [
      "/assets/celebrities/photos/3x1-ryan-coogler.webp",
      "/assets/celebrities/photos/3x2-ryan-coogler.jpg",
      "/assets/celebrities/photos/3x3-ryan-coogler.jpg",
    ],
    ...
    video_thumbnail: "/assets/celebrities/videos/3-ryan-coogler.webp",
  },
  {
    id: 4,
    sex: "male",
    ...
    video: "h37XmTPfweA",
    photos: [
      "/assets/celebrities/photos/4x1-idris-elba.webp",
      "/assets/celebrities/photos/4x2-idris-elba.jpg",
      "/assets/celebrities/photos/4x3-idris-elba.webp",
    ],
    ...
    video_thumbnail: "/assets/celebrities/videos/4-idris-elba.jpg",
  },
  {
    id: 5,
    sex: "female",
    ...
    video: "csRFZsA7W1c",
    photos: [
      "/assets/celebrities/photos/5x1-danai-gurira.webp",
      "/assets/celebrities/photos/5x2-danai-gurira.jpg",
      "/assets/celebrities/photos/5x3-danai-gurira.jpg",
    ],
    country: "Zimbabwe",
    celebId: 10104,
    category: "actress",
    ...
    video_thumbnail: "/assets/celebrities/videos/5-danai-gurira.jpg",
  },
  {
    id: 6,
    sex: "male",
    ...
    video: "Fvgf27OtiZo",
    photos: [
      "/assets/celebrities/photos/6x1-don-cheadle.jpg",
      "/assets/celebrities/photos/6x2-don-cheadle.jpg",
      "/assets/celebrities/photos/6x3-don-cheadle.jpg",
    ],
    country: "United States",
    celebId: 10015,
    category: "actor",
    ...
    video_thumbnail: "/assets/celebrities/videos/6-don-cheadle.jpg",
  },
  {
    id: 7,
    sex: "female",
    ...
    video: "pYwUeSC2mZE",
    photos: [
      "/assets/celebrities/photos/7x1-sophie-okonedo.jpg",
      "/assets/celebrities/photos/7x2-sophie-okonedo.jpg",
      "/assets/celebrities/photos/7x3-sophie-okonedo.webp",
    ],
    country: "United Kingdom",
    celebId: 10008,
    category: "actress",
    ...
    video_thumbnail: "/assets/celebrities/videos/7-sophie-okonedo.jpg",
  },
  {
    id: 8,
    sex: "male",
    ...
    video: "4lf1B_yeYkA",
    photos: [
      "/assets/celebrities/photos/8x1-chiwetel-ejiofor.jpg",
      "/assets/celebrities/photos/8x2-chiwetel-ejiofor.jpg",
      "/assets/celebrities/photos/8x3-chiwetel-ejiofor.jpg",
    ],
    country: "Nigeria",
    celebId: 10425,
    category: "actor",
    ...
    video_thumbnail: "/assets/celebrities/videos/8-chiwetel-ejiofor.jpg",
  },
];
