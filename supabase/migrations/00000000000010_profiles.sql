...
begin
    ...
    insert into public.profiles (id, name, email, full_name, avatar_url) 
    values (new.id, generated_user_name, new.email, new.raw_user_meta_data->>'full_name', new.raw_user_meta_data->>'avatar_url');
